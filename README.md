# 書籍「ブラウザオーケストレーション・コーディング」のサンプル一式

書籍「ブラウザオーケストレーション・コーディング」のサンプルプログラム一式のリポジトリです。本書では、ブラウザを中心としたWeb技術を利用して、さまざまな自動処理を行ったり、ブラウザ拡張を作ったり、Electron/Wails/Tauriのようなブラウザ・コンポーネントを利用したアプリの作り方を紹介したりします。
